const GEOM_KEY = 'aw139_adc_geometry_v35';
    const CUSTOM_BASES_KEY = 'aw139_adc_custom_bases_v3';
    const INBOX_KEY = 'aw139_adc_inbox_v1';
    const STATE_KEY = 'aw139_adc_state_v35';

    const BUILTIN_BASES = {"SBNF": {"id": "SBNF", "code": "SBNF", "name": "Navegantes / Ministro Victor Konder, INTL", "city": "SC - Brasil", "adcTitle": "SBNF ADC 15 MAY 25", "engineId": "adc_sbnf_v1", "stability": "stable", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_08_26", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbnf_chart_p1.png", "assetName": "sbnf_chart_p1.png", "size": {"width": 1191, "height": 1684}}], "runways": [{"id": "RWY_08_26", "label": "08/26", "chartId": "ADC_MAIN", "referenceEnd": "26", "ends": ["08", "26"], "lengthM": 1800, "widthM": 45, "widthPx": 45, "thresholdRef": {"x": 214.72, "y": 285.08}, "thresholdOpp": {"x": 930.99, "y": 1383.82}, "declaredDistances": {"26": {"tora": 1800, "toda": 1800, "asda": 1800, "lda": 1800}, "08": {"tora": 1800, "toda": 1800, "asda": 1800, "lda": 1800}}, "intersections": [{"id": "B", "name": "TWY B", "metersFromRef": 739, "labelPoint": {"x": 545.2, "y": 707.89}}, {"id": "A", "name": "TWY A", "metersFromRef": 891, "labelPoint": {"x": 608.08, "y": 799.51}}], "endFeatures": {"08": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "26": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}]}, "SBME": {"id": "SBME", "code": "SBME", "name": "Macaé / Joaquim de Azevedo Mancebo", "city": "RJ - Brasil", "adcTitle": "SBME ADC 10 JUL 25", "engineId": "adc_sbme_v1", "stability": "stable", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_05_23", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbme_chart_p1.png", "assetName": "sbme_chart_p1.png", "size": {"width": 862, "height": 1300}}], "runways": [{"id": "RWY_05_23", "label": "05/23", "chartId": "ADC_MAIN", "referenceEnd": "23", "ends": ["05", "23"], "lengthM": 1410, "widthM": 30, "widthPx": 27, "thresholdRef": {"x": 617.68, "y": 268.22}, "thresholdOpp": {"x": 182.56, "y": 1068.5}, "declaredDistances": {"23": {"tora": 1410, "toda": 1410, "asda": 1410, "lda": 1410}, "05": {"tora": 1410, "toda": 1410, "asda": 1410, "lda": 1410}}, "intersections": [{"id": "D", "name": "TWY D", "metersFromRef": 216, "labelPoint": {"x": 573.15, "y": 404.58}}, {"id": "B", "name": "TWY B", "metersFromRef": 623, "labelPoint": {"x": 454, "y": 633}}, {"id": "A", "name": "TWY A", "metersFromRef": 1101, "labelPoint": {"x": 294.69, "y": 899.21}}], "endFeatures": {"05": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "23": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}, {"id": "RWY_06_24", "label": "06/24", "chartId": "ADC_MAIN", "referenceEnd": "24", "ends": ["06", "24"], "lengthM": 899, "widthM": 30, "widthPx": 25, "thresholdRef": {"x": 668, "y": 329}, "thresholdOpp": {"x": 250, "y": 969}, "declaredDistances": {"24": {"tora": 899, "toda": 899, "asda": 899, "lda": 899}, "06": {"tora": 899, "toda": 899, "asda": 899, "lda": 899}}, "intersections": [{"id": "D", "name": "TWY D", "metersFromRef": 150, "labelPoint": {"x": 650, "y": 442}}, {"id": "B", "name": "TWY B", "metersFromRef": 430, "labelPoint": {"x": 502, "y": 680}}, {"id": "A", "name": "TWY A", "metersFromRef": 760, "labelPoint": {"x": 286, "y": 937}}], "endFeatures": {"06": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "24": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}]}, "SBVT": {"id": "SBVT", "code": "SBVT", "name": "Vitória / Eurico de Aguiar Salles, INTL", "city": "ES - Brasil", "adcTitle": "SBVT ADC 23 MAR 23", "engineId": "adc_sbvt_v1", "stability": "draft", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_06_24", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbvt_chart_p1.png", "assetName": "sbvt_chart_p1.png", "size": {"width": 863, "height": 1300}}], "runways": [{"id": "RWY_06_24", "label": "06/24", "chartId": "ADC_MAIN", "referenceEnd": "24", "ends": ["06", "24"], "lengthM": 1750, "widthM": 45, "widthPx": 26, "thresholdRef": {"x": 514, "y": 402}, "thresholdOpp": {"x": 210, "y": 875}, "declaredDistances": {"24": {"tora": 1750, "toda": 1750, "asda": 1750, "lda": 1750}, "06": {"tora": 1750, "toda": 1750, "asda": 1750, "lda": 1750}}, "intersections": [{"id": "E", "name": "TWY E", "metersFromRef": 77, "labelPoint": {"x": 540, "y": 448}}, {"id": "D", "name": "TWY D", "metersFromRef": 794, "labelPoint": {"x": 428, "y": 650}}, {"id": "C", "name": "TWY C", "metersFromRef": 809, "labelPoint": {"x": 382, "y": 626}}, {"id": "B", "name": "TWY B", "metersFromRef": 1112, "labelPoint": {"x": 309, "y": 695}}, {"id": "A", "name": "TWY A", "metersFromRef": 1341, "labelPoint": {"x": 274, "y": 760}}], "endFeatures": {"06": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "24": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}, {"id": "RWY_02_20", "label": "02/20", "chartId": "ADC_MAIN", "referenceEnd": "20", "ends": ["02", "20"], "lengthM": 2058, "widthM": 45, "widthPx": 28, "thresholdRef": {"x": 592, "y": 278}, "thresholdOpp": {"x": 673, "y": 947}, "declaredDistances": {"20": {"tora": 2058, "toda": 2058, "asda": 2058, "lda": 2058}, "02": {"tora": 2058, "toda": 2058, "asda": 2058, "lda": 2058}}, "intersections": [{"id": "M", "name": "TWY M", "metersFromRef": 209, "labelPoint": {"x": 582, "y": 348}}, {"id": "K", "name": "TWY K", "metersFromRef": 509, "labelPoint": {"x": 574, "y": 448}}, {"id": "J", "name": "TWY J", "metersFromRef": 1258, "labelPoint": {"x": 615, "y": 690}}, {"id": "H", "name": "TWY H", "metersFromRef": 2036, "labelPoint": {"x": 639, "y": 944}}], "endFeatures": {"02": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "20": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}]}, "SBGL": {"id": "SBGL", "code": "SBGL", "name": "Rio de Janeiro / Galeão - Antônio Carlos Jobim, INTL", "city": "RJ - Brasil", "adcTitle": "SBGL ADC 05 SEP 24", "engineId": "adc_sbgl_v1", "stability": "draft", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_10_28", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbgl_chart_p1.png", "assetName": "sbgl_chart_p1.png", "size": {"width": 863, "height": 1300}}], "runways": [{"id": "RWY_10_28", "label": "10/28", "chartId": "ADC_MAIN", "referenceEnd": "28", "ends": ["10", "28"], "lengthM": 4000, "widthM": 45, "widthPx": 27, "thresholdRef": {"x": 96, "y": 267}, "thresholdOpp": {"x": 292, "y": 939}, "declaredDistances": {"10": {"tora": 4000, "toda": 4000, "asda": 4000, "lda": 4000}, "28": {"tora": 4000, "toda": 4000, "asda": 4000, "lda": 4000}}, "intersections": [{"id": "DD", "name": "TWY DD", "metersFromRef": 1550, "labelPoint": {"x": 187, "y": 523}}, {"id": "CC", "name": "TWY CC", "metersFromRef": 1904, "labelPoint": {"x": 196, "y": 585}}, {"id": "BB", "name": "TWY BB", "metersFromRef": 2339, "labelPoint": {"x": 224, "y": 656}}, {"id": "AA", "name": "TWY AA", "metersFromRef": 2682, "labelPoint": {"x": 243, "y": 713}}], "endFeatures": {"10": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "28": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}, {"id": "RWY_15_33", "label": "15/33", "chartId": "ADC_MAIN", "referenceEnd": "33", "ends": ["15", "33"], "lengthM": 3180, "widthM": 47, "widthPx": 27, "thresholdRef": {"x": 703, "y": 680}, "thresholdOpp": {"x": 452, "y": 1030}, "declaredDistances": {"15": {"tora": 3060, "toda": 3180, "asda": 3060, "lda": 2930}, "33": {"tora": 3050, "toda": 3180, "asda": 3050, "lda": 2930}}, "intersections": [{"id": "J", "name": "TWY J", "metersFromRef": 288, "labelPoint": {"x": 650, "y": 690}}, {"id": "L", "name": "TWY L", "metersFromRef": 748, "labelPoint": {"x": 617, "y": 743}}, {"id": "B", "name": "TWY B", "metersFromRef": 2447, "labelPoint": {"x": 487, "y": 933}}], "endFeatures": {"15": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 120.0}, "33": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 130.0}}}]}, "SBRJ": {"id": "SBRJ", "code": "SBRJ", "name": "Rio de Janeiro / Santos Dumont", "city": "RJ - Brasil", "adcTitle": "SBRJ ADC 27 NOV 25", "engineId": "adc_sbrj_v1", "stability": "draft", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_20R_02L", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbrj_chart_p1.png", "assetName": "sbrj_chart_p1.png", "size": {"width": 863, "height": 1300}}], "runways": [{"id": "RWY_20L_02R", "label": "20L/02R", "chartId": "ADC_MAIN", "referenceEnd": "20L", "ends": ["02R", "20L"], "lengthM": 1323, "widthM": 42, "widthPx": 35, "thresholdRef": {"x": 364, "y": 305}, "thresholdOpp": {"x": 399, "y": 1084}, "declaredDistances": {"02R": {"tora": 1323, "toda": 1323, "asda": 1323, "lda": 1323}, "20L": {"tora": 1323, "toda": 1323, "asda": 1323, "lda": 1323}}, "intersections": [{"id": "A", "name": "TWY A", "metersFromRef": 45, "labelPoint": {"x": 312, "y": 334}}, {"id": "B", "name": "TWY B", "metersFromRef": 403, "labelPoint": {"x": 363, "y": 543}}, {"id": "C", "name": "TWY C", "metersFromRef": 991, "labelPoint": {"x": 374, "y": 889}}, {"id": "D", "name": "TWY D", "metersFromRef": 1162, "labelPoint": {"x": 394, "y": 989}}], "endFeatures": {"02R": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "20L": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}, {"id": "RWY_20R_02L", "label": "20R/02L", "chartId": "ADC_MAIN", "referenceEnd": "20R", "ends": ["02L", "20R"], "lengthM": 1260, "widthM": 30, "widthPx": 24, "thresholdRef": {"x": 410, "y": 305}, "thresholdOpp": {"x": 450, "y": 1090}, "declaredDistances": {"02L": {"tora": 1260, "toda": 1260, "asda": 1260, "lda": 1260}, "20R": {"tora": 1260, "toda": 1260, "asda": 1260, "lda": 1260}}, "intersections": [{"id": "A", "name": "TWY A", "metersFromRef": 43, "labelPoint": {"x": 391, "y": 333}}, {"id": "H", "name": "TWY H", "metersFromRef": 379, "labelPoint": {"x": 399, "y": 542}}, {"id": "G", "name": "TWY G", "metersFromRef": 931, "labelPoint": {"x": 421, "y": 886}}, {"id": "F", "name": "TWY F", "metersFromRef": 1106, "labelPoint": {"x": 430, "y": 995}}, {"id": "E", "name": "TWY E", "metersFromRef": 1190, "labelPoint": {"x": 431, "y": 1047}}], "endFeatures": {"02L": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "20R": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}]}, "SBJR": {"id": "SBJR", "code": "SBJR", "name": "Rio de Janeiro / Jacarepaguá - Roberto Marinho", "city": "RJ - Brasil", "adcTitle": "SBJR ADC 27 NOV 25", "engineId": "adc_sbjr_v1", "stability": "draft", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_03_21", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbjr_chart_p1.png", "assetName": "sbjr_chart_p1.png", "size": {"width": 863, "height": 1300}}], "runways": [{"id": "RWY_03_21", "label": "03/21", "chartId": "ADC_MAIN", "referenceEnd": "21", "ends": ["03", "21"], "lengthM": 900, "widthM": 30, "widthPx": 18, "thresholdRef": {"x": 349, "y": 360}, "thresholdOpp": {"x": 309, "y": 995}, "declaredDistances": {"21": {"tora": 900, "toda": 900, "asda": 900, "lda": 900}, "03": {"tora": 900, "toda": 900, "asda": 900, "lda": 900}}, "intersections": [{"id": "D", "name": "TWY D", "metersFromRef": 309, "labelPoint": {"x": 364, "y": 580}}, {"id": "C", "name": "TWY C", "metersFromRef": 584, "labelPoint": {"x": 351, "y": 774}}, {"id": "A", "name": "TWY A", "metersFromRef": 801, "labelPoint": {"x": 372, "y": 929}}, {"id": "B", "name": "TWY B", "metersFromRef": 894, "labelPoint": {"x": 342, "y": 993}}], "endFeatures": {"03": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "21": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}]}, "SBCB": {"id": "SBCB", "code": "SBCB", "name": "Cabo Frio / Cabo Frio, INTL", "city": "RJ - Brasil", "adcTitle": "SBCB ADC 16 JUN 22", "engineId": "adc_sbcb_v1", "stability": "draft", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_10_28", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbcb_chart_p1.png", "assetName": "sbcb_chart_p1.png", "size": {"width": 863, "height": 1300}}], "runways": [{"id": "RWY_10_28", "label": "10/28", "chartId": "ADC_MAIN", "referenceEnd": "10", "ends": ["10", "28"], "lengthM": 2550, "widthM": 45, "widthPx": 29, "thresholdRef": {"x": 448, "y": 233}, "thresholdOpp": {"x": 651, "y": 1111}, "declaredDistances": {"10": {"tora": 2460, "toda": 2550, "asda": 2460, "lda": 2370}, "28": {"tora": 2460, "toda": 2550, "asda": 2460, "lda": 2370}}, "intersections": [{"id": "A", "name": "TWY A", "metersFromRef": 13, "labelPoint": {"x": 430, "y": 242}}, {"id": "B", "name": "TWY B", "metersFromRef": 403, "labelPoint": {"x": 457, "y": 377}}], "endFeatures": {"10": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 90.0}, "28": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 90.0}}}]}, "SBFS": {"id": "SBFS", "code": "SBFS", "name": "Campo dos Goytacazes / Farol de São Tomé", "city": "RJ - Brasil", "adcTitle": "SBFS ADC 19 FEB 26", "engineId": "adc_sbfs_v1", "stability": "draft", "locked": true, "schemaVersion": 4, "defaultChartId": "ADC_MAIN", "defaultRunwayId": "RWY_15_33", "charts": [{"id": "ADC_MAIN", "label": "ADC principal", "asset": "sbfs_chart_p1.png", "assetName": "sbfs_chart_p1.png", "size": {"width": 863, "height": 1300}}], "runways": [{"id": "RWY_15_33", "label": "15/33", "chartId": "ADC_MAIN", "referenceEnd": "15", "ends": ["15", "33"], "lengthM": 580, "widthM": 31.5, "widthPx": 24, "thresholdRef": {"x": 203, "y": 559}, "thresholdOpp": {"x": 684, "y": 813}, "declaredDistances": {"15": {"tora": 580, "toda": 580, "asda": 580, "lda": 580}, "33": {"tora": 580, "toda": 580, "asda": 580, "lda": 580}}, "intersections": [{"id": "B", "name": "TWY B", "metersFromRef": 15, "labelPoint": {"x": 250, "y": 501}}, {"id": "A", "name": "TWY A", "metersFromRef": 301, "labelPoint": {"x": 475, "y": 649}}], "endFeatures": {"15": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}, "33": {"displacedThresholdM": 0.0, "stopwayM": 0.0, "clearwayM": 0.0}}}]}};
    ...
    const ENGINE_REGISTRY = {
      adc_generic_v1: {
        ...
        analyze({ base, runway, dep, rto }) {
          ...
          const features = runway.endFeatures?.[dep] || { displacedThresholdM: 0, stopwayM: 0, clearwayM: 0 };
          const meta = departureMeta(runway, dep);
          const starts = [{ id: 'FULL', name: meta.startThr, metersFromRef: meta.fullLengthMetersFromRef }]
            .concat((runway.intersections || []).map(it => ({ id: it.id, name: it.name, metersFromRef: it.metersFromRef })));
    ...
    function mergedLibrary() { return { ...clone(BUILTIN_BASES), ...loadCustomBases() }; }
      ...
      if (!currentGeometry[baseId].runways[runwayId]) {
        ...
        currentGeometry[baseId].runways[runwayId] = {
          ...
          endData: Object.fromEntries((rw.ends || []).map(end => [end, {
            ...
            features: clone(rw.endFeatures?.[end] || { displacedThresholdM: 0, stopwayM: 0, clearwayM: 0 })
          }]))
        };
      }
    ...
    function departureMeta(runway = currentRunway(), dep = state.departureEnd) {
      ...
      return dep === opp
        ? { startThr: opp, endThr: ref, fullLengthMetersFromRef: runway.lengthM, ref, opp }
        : { startThr: ref, endThr: opp, fullLengthMetersFromRef: 0, ref, opp };
    }
    function distanceFromStart(startMetersFromRef, runway = currentRunway(), dep = state.departureEnd) {
      return dep === currentOppositeEnd(runway) ? runway.lengthM - startMetersFromRef : startMetersFromRef;
    }
    function gateMetersFromRef(gateOffsetFromStart, runway = currentRunway(), dep = state.departureEnd) {
      return dep === currentOppositeEnd(runway) ? runway.lengthM - gateOffsetFromStart : gateOffsetFromStart;
    }
    ...
    function selectedEndFeatures(runway = currentRunway(), dep = state.departureEnd) {
      return clone(runway.endFeatures?.[dep] || { displacedThresholdM: 0, stopwayM: 0, clearwayM: 0 });
    }
    ...
    function resetDeclaredInputs() {
      ...
      rec.endData[end] = {
        ...
        features: clone(rawRunway.endFeatures?.[end] || { displacedThresholdM: 0, stopwayM: 0, clearwayM: 0 })
      };
      saveGeometry();
      renderDeclaredInputs();
      renderAnchorTable();
    ...
    function anchorKeys() {
      ...
      const keys = [
        { key: 'pavementRef', label: `Pavimento ${runway.referenceEnd}` },
        { key: 'thresholdRef', label: `Cabeceira ${runway.referenceEnd}` },
        { key: 'thresholdOpp', label: `Cabeceira ${currentOppositeEnd(runway)}` },
        { key: 'pavementOpp', label: `Pavimento ${currentOppositeEnd(runway)}` }
      ];
      runway.intersections.forEach(it => {
        keys.push({ key: `axis_${it.id}`, label: `${it.name} alinhamento` });
    ...
    function persistCurrentRunwayGeometry() {
      ...
      currentGeometry[baseId].runways[runwayId] = {
        ...
        endData: Object.fromEntries((runway.ends || []).map(end => [end, {
          ...
          features: clone(runway.endFeatures?.[end] || { displacedThresholdM: 0, stopwayM: 0, clearwayM: 0 })
        }]))
      };
      saveGeometry();
    }
    ...
    function drawPavementMarkers(runway) {
      const pRef = toScreen(runway.pavementRef || runway.thresholdRef);
      const pOpp = toScreen(runway.pavementOpp || runway.thresholdOpp);
      [pRef, pOpp].forEach(p => {
        ctx.beginPath();
    ...
    function drawThresholdMarkers(runway) {
      const pRef = toScreen(runway.thresholdRef);
      const pOpp = toScreen(runway.thresholdOpp);
      [pRef, pOpp].forEach(p => {
        ctx.beginPath();
    ...
    function drawRequiredArrow(runway, dep, requiredMeters, color, label) {
      const g = runwayGeometry(runway);
      const clampedReq = clamp(requiredMeters, 0, runway.lengthM);
      const startMRef = dep === currentOppositeEnd(runway) ? clampedReq : runway.lengthM - clampedReq;
      const endMRef = dep === currentOppositeEnd(runway) ? 0 : runway.lengthM;
    ...
    function drawStatusBarAtPoint(runway, metersFromRef, label, valueMeters, ok, dep, shiftIndex = 0, labelPoint = null) {
      ...
      const half = runway.widthPx * state.scale * 0.64;
    ...
    function drawRunwayOverlay(runway, a) {
      ...
      drawRequiredArrow(runway, a.dep, a.rto, rtoOk ? '#7CFC00' : '#ef4444', 'RTO');
      ...
      ctx.stroke();
      ctx.restore();
      const depLabelPoint = a.dep === currentOppositeEnd(runway)
      ...
      drawStatusBarAtPoint(runway, a.meta.fullLengthMetersFromRef, a.meta.startThr, fullRow?.availableAsda ?? a.declared.asda, !!fullRow?.go, a.dep, 0, depLabelPoint);
      ...
      sorted.forEach((row, idx) => {
        ...
        drawStatusBarAtPoint(runway, row.metersFromRef, row.id, row.availableAsda, row.go, a.dep, idx + 1, baseIntersection?.labelPoint || null);
      });
    }
    function drawIntersection(runway, it) {
      ...
      ctx.fillStyle = 'rgba(139,92,246,.80)';
      ctx.fill();
